...
% Obs_ini is the starting point of its internal line segment (it has to be a row vector)
% Obs_end is the end point of its internal line segment (it has to be a row vector)
