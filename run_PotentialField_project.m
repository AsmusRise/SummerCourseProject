%% UR5 PotentialField motion-planning runner
% Add obstacles in Obs. The PotentialField planning, smoothing, drawing, saving,
...
[path, smoothPath] = PotentialField2(C_ini, C_goal, Obs);
...
fprintf('Raw PotentialField path: %d configurations\n', size(path, 1));
...
for i = 1:(size(waypoints, 1) - 1)
    ...
    ParaInitialize(C_ini, C_goal, Obs);
    [~, smoothPath] = PotentialField2(C_ini, C_goal, Obs);
